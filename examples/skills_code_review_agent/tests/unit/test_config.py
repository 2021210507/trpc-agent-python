...
def test_architecture_skeleton_is_present() -> None:
    expected_modules = {
        ...
        "codereview/pipeline.py",
        "codereview/inputs.py",
        "codereview/governance.py",
        "codereview/sandbox.py",
        "codereview/redaction.py",
        "codereview/dedup.py",
        "codereview/llm_enhancer.py",
        "codereview/report.py",
        "codereview/metrics.py",
        "codereview/store/__init__.py",
        "codereview/store/models.py",
        "codereview/store/review_store.py",
        "codereview/store/init_db.py",
