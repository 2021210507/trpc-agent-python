...
- `fixtures/`: test inputs and expected data only; executable tests do not live here. `diffs/` contains eight small smoke cases and eight paired `_realistic` cases with multi-file engineering context.
